...
$sb = { 
    ...
    return ( Get-SPDatabase | Where { $_.Type -eq "Content Database" -and $_.Name -inotmatch "Administration_Content_Database" } | Select Name, Server, @{Name="Size";Expression={$_.DiskSizeRequired/1mb}}, @{Name="Sites";Expression={$_.CurrentSiteCount}} )
